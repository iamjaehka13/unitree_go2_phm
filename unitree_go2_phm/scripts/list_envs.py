...
def _is_project_env(task_spec: gym.envs.registration.EnvSpec) -> bool:
    ...
    return "unitree_go2_phm" in entry_point or "unitree_go2_phm" in env_cfg_entry_point


def main():
    """Print all environments registered in `unitree_go2_phm` extension."""
    ...
    if index == 0:
        print("No matching unitree_go2_phm environments were found.")
    else:
        print(table)
