...
def _repo_root() -> Path:
    # .../unitree_go2_phm/unitree_go2_phm/scripts/real/check_sdk_setup.py
...
def main() -> int:
    ...
    print("  2) Optional prune: python3 unitree_go2_phm/scripts/real/prune_sdk2_for_go2.py --apply")
    print("  3) Build bridge: cmake -S unitree_go2_phm/scripts/real/sdk2_bridge -B /tmp/go2_udp_bridge_build && cmake --build /tmp/go2_udp_bridge_build -j")
