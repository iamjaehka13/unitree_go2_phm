...
class PhmRealismActuator(ImplicitActuator):
    ...
    def __init__(self, cfg: ImplicitActuatorCfg, *args, **kwargs):
        ...
        self._phm_state: PHMState | None = None
        self._asset: Articulation | None = None

    def bind_phm_state(self, phm_state: PHMState):
        self._phm_state = phm_state
    ...
    def compute(
        ...
        # UnitreeGo2PhmEnv._apply_physical_degradation() in the physics loop.
