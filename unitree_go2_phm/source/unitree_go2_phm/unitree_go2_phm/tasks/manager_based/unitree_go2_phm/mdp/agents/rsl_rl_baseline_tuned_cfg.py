...
@configclass
class UnitreeGo2BaselineTunedPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    """Runner config for Baseline-Tuned track (separate experiment namespace)."""

    # Literature-aligned PPO defaults (2109.11978 + legged_gym convention).
    num_steps_per_env = 24
    max_iterations = 3000
    save_interval = 50
    experiment_name = "unitree_go2_baseline_tuned"
