...
class PHMState:
    """
    [PHM Core] 로봇 하드웨어의 동적 건전성 상태(State of Health)를 관리하는 중앙 데이터 컨테이너.
    """
    ...
    def __init__(self, num_envs: int, num_joints: int, device: str):
        ...
        # Per-cell model parameters (episode-randomized in reset_phm_interface).
    ...
    def reset(self, env_ids: torch.Tensor):
        ...
        # [Fix] encoder_offset도 리셋 (reset_phm_interface에서 재랜덤화하지만,
