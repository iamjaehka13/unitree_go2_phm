# Newton(MuJoCo-Warp) 실행 런북 (Isaac Lab)

작성일: 2026-02-16

이 문서는 **Isaac Lab에서 Unitree Go2 PHM 정책을 Newton(MuJoCo-Warp 백엔드)**로 실행/재생하기 위한 최소 절차를 정리합니다.

## 0) 전제 경로

- IsaacLab 루트: `/home/iamjaehka13/IsaacLab`
- 이 프로젝트 루트: `/home/iamjaehka13/unitree_go2_phm`
- 확장 패키지 경로: `/home/iamjaehka13/unitree_go2_phm/unitree_go2_phm/source/unitree_go2_phm`
- 재생 스크립트 경로: `/home/iamjaehka13/unitree_go2_phm/unitree_go2_phm/scripts/rsl_rl/play.py`
...
## 3) Go2 PHM 확장 설치 (IsaacLab Python으로)

```bash
cd /home/iamjaehka13/IsaacLab

./isaaclab.sh -p -m pip install -e \
  /home/iamjaehka13/unitree_go2_phm/unitree_go2_phm/source/unitree_go2_phm
```
...
./isaaclab.sh -p /home/iamjaehka13/unitree_go2_phm/unitree_go2_phm/scripts/list_envs.py
```
...
./isaaclab.sh -p /home/iamjaehka13/unitree_go2_phm/unitree_go2_phm/scripts/rsl_rl/play.py \
...
./isaaclab.sh -p /home/iamjaehka13/unitree_go2_phm/unitree_go2_phm/scripts/rsl_rl/train.py \
  --task Unitree-Go2-Phm-v1 \
  --num_envs 4096 \
  --max_iterations 3000 \
  --headless \
